...
func NewCfgGetRequest(id, offset, length byte) Message {
	return NewMessage(COMMAND_CFG_GET_REQ, []byte{id, offset, length})
}

func NewCfgGetResponse(id, offset byte, data []byte) Message {
	return NewMessage(COMMAND_CFG_GET_RSP, append([]byte{id, offset}, data...))
}

func NewCfgSetRequest(id, offset byte, data []byte) Message {
	return NewMessage(COMMAND_CFG_SET_REQ, append([]byte{id, offset}, data...))
}

func NewCfgSetResponse(id, offset byte, data []byte) Message {
	return NewMessage(COMMAND_CFG_SET_RSP, append([]byte{id, offset}, data...))
}
